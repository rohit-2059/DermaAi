...
TWILIO_SID = os.getenv("TWILIO_SID", "YOUR_ACTUAL_SID_HERE")
TWILIO_AUTH_TOKEN = os.getenv("TWILIO_AUTH_TOKEN", "YOUR_ACTUAL_AUTH_TOKEN_HERE")
...
if TWILIO_SID != "YOUR_ACTUAL_SID_HERE" and TWILIO_AUTH_TOKEN != "YOUR_ACTUAL_AUTH_TOKEN_HERE":
    client = Client(TWILIO_SID, TWILIO_AUTH_TOKEN)
else:
    client = None
    print("⚠️ Twilio credentials not configured. SMS functionality will be disabled.")
